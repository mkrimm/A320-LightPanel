...
![LightPanel](doc/images/LightPanel.JPEG)
...
To make it as easy as possible for you to get started, you will find a [SPAD.next profile](https://www.spadnext.com/download.html) for the [Fenix A320 family](https://fenixsim.com/) in the [doc](doc) folder.
<br><br>
...
You can find all the files to build the light control panel yourself on [Cults](https://cults3d.com/).
